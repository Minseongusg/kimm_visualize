...
int main(int argc, char** argv)
{
    ...
    ros::Publisher pub5 = nh.advertise<PointCloud> ("points_test_map5",1);
    ros::Publisher pub6 = nh.advertise<PointCloud> ("points_test_map6",1);
    ros::Publisher pub7 = nh.advertise<PointCloud> ("points_test_map7",1);
    ros::Publisher pub8 = nh.advertise<PointCloud> ("points_test_map8",1);
